...
export const sampleProject: ProjectDocument = {
  ...
  components: {
    ...
    'comp-list-empty-alert': {
      ...
      config: {
        kind: 'alert',
        tone: 'info',
        message: 'No tasks yet. Create the first task for your team.',
      },
    },
    'comp-list-error-alert': {
      id: 'comp-list-error-alert',
      screenId: 'screen-list',
      parentId: 'comp-list-section',
      childIds: [],
      kind: 'alert',
    ...
    'comp-create-task-progress-alert': {
      id: 'comp-create-task-progress-alert',
      screenId: 'screen-list',
      parentId: 'comp-create-modal-content',
      childIds: [],
      kind: 'alert',
      common: { description: 'Create task progress', visible: false, enabled: true },
      config: { kind: 'alert', tone: 'info', message: 'Creating task...' },
    },
    'comp-create-task-error-alert': {
      id: 'comp-create-task-error-alert',
      screenId: 'screen-list',
      parentId: 'comp-create-modal-content',
      childIds: [],
      kind: 'alert',
      common: { description: 'Create task error', visible: false, enabled: true },
      config: { kind: 'alert', tone: 'error', message: 'Could not create the task. Try again.' },
    },
    'comp-create-modal-actions': {
    ...
    'comp-save-error-alert': {
      ...
      config: {
        kind: 'alert',
        tone: 'error',
        message: 'Could not update the task. Review the details and try again.',
      },
    },
    'comp-actions': {
      id: 'comp-actions',
  ...
  screenStates: {
    ...
    'state-list-loading': {
      ...
      componentOverrides: {
        'comp-list-loading-alert': { visible: true },
    ...
    'state-list-empty': {
      ...
      componentOverrides: {
        'comp-list-empty-alert': { visible: true },
        'comp-list-grid': { visible: false },
      },
    },
    'state-list-error': {
      ...
      componentOverrides: {
        'comp-list-error-alert': { visible: true },
        'comp-list-grid': { visible: false },
    ...
    'state-list-creating': {
      ...
      componentOverrides: {
        ...
        'comp-create-task-progress-alert': { visible: true },
    ...
    'state-list-create-error': {
      ...
      componentOverrides: {
        'comp-create-modal': { visible: true },
        'comp-create-task-error-alert': { visible: true },
      },
    },
    'state-edit-default': {
    ...
    'state-edit-saving': {
      ...
      componentOverrides: {
        ...
        'comp-saving-alert': { visible: true },
    ...
    'state-edit-success': {
      ...
      componentOverrides: {
        'comp-status-alert': { visible: true },
    ...
    'state-edit-error': {
      ...
      componentOverrides: {
        'comp-save-error-alert': { visible: true },
      },
    },
    'state-edit-confirm-exit': {
