...
- Inspectorで選択componentのeventと実行順actionを追加・編集・削除し、API request binding・結果state、validation ruleを参照
...
- Buttonや入力componentを選択し、Inspectorの「振る舞い」でeventと実行順actionを編集。API／validation仕様は参照のみ
